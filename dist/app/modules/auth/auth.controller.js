...
exports.AuthController = exports.signUpUser = void 0;
...
exports.signUpUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.signUpUser(loginData);
...
const loginUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // set cookies
    const cookieOptions = {
        secure: config_1.default.node_type === 'production' ? true : false,
        httpOnly: true,
    };
...
const getLoggedInUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.getLoggedInUser(token);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
        message: '',
